...
aws s3 sync --acl public-read --profile newsapps --exclude '*.*' --include '*.svg' --cache-control 'max-age=604800' --content-encoding 'gzip' dist s3://$APP_S3_BUCKET/$PROJECT_SLUG/
